...
/**
  ...
  */
object CoinNginxAPI extends Serializable with Logging {
  ...
  def parseLog(line: String): Row = {
    try {
      ...
      val logModel = LogConvertUtil.mapper.readValue(newLine, classOf[CoinNginxAPILogModel])
